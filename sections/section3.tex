...
\end{bmatrix}
(-x\sin\theta+y\cos\phi\cos\theta+z\cos\phi\cos\theta)dm\\
R_0^2
\end{align}
\begin{align}
...
\begin{align}
I_1\ddot{\theta}-(I_1+I_3-I_2)\omega_c\dot{\phi}+
...
安定条件は?
\end{enumerate}
\underline{十分条件} Cがpositive definite(正定)であること
$(\forall x, \bm{x}^T C \bm{x} > 0)$ \\
$\therefore I_2 - I_3 >0\wedge_2 - I_1 > 0$\\
