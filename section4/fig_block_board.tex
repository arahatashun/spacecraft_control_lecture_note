...
\draw ($(outer)+(0, 1)$)node[above right]{$M_y$\textcolor{darkgreen}{外乱トルク}}--(outer);
...
\draw [<-] ($(diff) + (0.6, -0.1)$) to[bend right=10] (2.5, -1)node[below right]{$\theta$はEarth Sensor,Sun Sensor};
\end{scope}
