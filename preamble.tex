...
% titles
\title{宇宙機制御工学\footnote{Tex Source \url{https://github.com/arahatashun/spacecraft_control}}}
...
\newcommand*\circled[1]{\kern-2.5em%
  \put(0,4){\color{white}\circle*{15}}\put(0,4){\circle{13}}%
  \put(-3,0){\color{black}\bfseries#1}~~}